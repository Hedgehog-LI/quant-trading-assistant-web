...
describe('reviewApi', () => {
  ...
  it('关联交易后 journal 自动标记 REVIEWED', () => {
    const j1 = addTradeJournal({ tradeDate: '2026-06-08', symbol: '300750', side: 'BUY', price: 100, quantity: 100, emotionTags: [], mistakeTags: [] });
    const j2 = addTradeJournal({ tradeDate: '2026-06-08', symbol: '600519', side: 'SELL', price: 200, quantity: 100, emotionTags: [], mistakeTags: [] });
    ...
    batchUpdateReviewStatus([j1.id], 'REVIEWED');
