    ...
    <div>
      ...
      <Card title="数据模式" size="small" style={{ marginBottom: 16 }}>
        <Typography.Paragraph type="secondary">
          ...
          <br />
          <strong>后端模式</strong>：核心业务数据（交易账本、持仓快照、自选股、交易计划、交易记录、盘后复盘）通过 REST API 写入后端数据库。
          <br />
            ...
            <Alert
              ...
              description={
                <ul style={{ margin: 0, paddingLeft: 18 }}>
                  <li>「交易账本」「持仓快照」「自选股」「交易计划」「交易记录」「盘后复盘」均已接入后端 API，核心数据落库；切换回本地模式仍使用 localStorage。</li>
